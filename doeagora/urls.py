...
urlpatterns = [
    ...
    path('cadastro-interesse', views.CadastroInteresseView.as_view(), name='c.beneficiario'),
    path('cadastro-doacaobeneficiario', views.CadastroDoacaoBeneficiarioView.as_view(), name='c.beneficiario'),
    ...
    path('listagem-interesse', views.VerListagemInteresseView.as_view(), name='verlistageminsteresse'),
    path('listagem-doacaobeneficiario', views.VerListagemDoacaoBeneficiarioView.as_view(), name='verlistagem_doador_beneficiario'),
